...
SELECT SUM(total_price)/(SELECT COUNT(DISTINCT order_id) FROM pizza_sales) AS Average_Order_Value FROM pizza_sales
...
SELECT SUM(quantity)/(SELECT COUNT(DISTINCT order_id) FROM pizza_sales) AS Average_Order_Quantity FROM pizza_sales

SELECT CAST(SUM(quantity) AS DECIMAL(10,2))/CAST((SELECT COUNT(DISTINCT order_id) FROM pizza_sales) AS DECIMAL(10, 2)) AS Average_Order_Quantity FROM pizza_sales
